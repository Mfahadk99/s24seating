export function buildVerifyEmailEmailTemplate(
  userId: string,
  host: string,
  token: string
): string {
  ...
  <head>
    ...
    <title>MyLittleHelper</title>
    <style type="text/css">
      /*******************FONT STYLING MyLittleHelper*********************/
  ...
  <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" yahoo="fix" style="font-family: 'Open Sans', Arial, sans-serif;" align="center" id="body">
    <custom type="content" name="ampscript">
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" class="mobileView" width="600" style="">
              <tr>
                <td align="center" bgcolor="#FFFFFF" style="padding:0px;" width="100%">
                        ...
                        <table cellspacing="0" cellpadding="0" align="left" border="0" width="100%" bgcolor="#ffffff">
                          <tr>
                            <td valign="top" align="left" width="100%" style="padding-left: 25px;">
                              <img style="max-width: 85px; height: auto" src="${process.env.BASE_URL}/assets/images/logo/logo-dark.png" alt="MyLittleHelper" />
                            </td>
                          </tr>
                        </table>
                        <table cellspacing="0" cellpadding="0" align="center" border="0" width="100%" bgcolor="#F3F3F5">
                      ...
                      <td bgcolor="" class="" style="width:100% !important; padding: 0;">
                        <custom type="content" name="hero_image">
                          ...
                          <table cellspacing="0" cellpadding="0" align="left" border="0" width="100%" bgcolor="#ffffff">
                            <tr>
                              <td valign="top" align="center" width="100%" style="padding-right: 25px; padding-left: 25px;">
                                <img width="100%" style="max-width: 600px; height: auto" src="${process.env.BASE_URL}/assets/images/logo/phone_sms.png" alt="MyLittleHelper" />
                              </td>
                            </tr>
                          </table>
                          <!--END HERO IMAGE-->
                          ...
                          <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px;">
                            <tr>
                              <td style="font-family: 'Roboto', Arial, Helvetica, sans-serif; font-size: 14px; line-height: 1.0; color: #000000; font-weight: bolder; text-transform: uppercase; padding: 25px 25px 5px 25px;" class="mso-line-solid">
                                YOU'RE ONE STEP AWAY
                              </td>
                            </tr>
                            <tr>
                              <td style="font-family: 'Roboto', Arial, Helvetica, sans-serif; font-size: 52px; line-height: 1.0; color: #000000; font-weight: bolder; padding: 0 25px 15px 25px;" class="mso-line-solid mobile-headline">
                                Verify your email address
                              </td>
                            </tr>
                            <tr>
                              <td style="font-family: 'Roboto', Arial, Helvetica, sans-serif; font-size: 18px; line-height: 1.4; color: #000000; padding: 0 25px 50px 25px;">
                                To complete your registration and start using MyLittleHelper, you'll need to verify your email address.
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td align="center" style="padding: 0 25px 30px 25px; background-color: #ffffff;">
                                <table align="center" cellpadding="0" cellspacing="0" border="0" class="full-width">
                                  <tr>
                                    <td class="cta-shadow" align="center" bgcolor="#3cd9f5" style="border-radius: 40px; -webkit-border-radius: 40px; -moz-border-radius: 40px;">
                                      <a href="http://${host}/verify_email?id=${userId}&token=${token}" target="_blank" style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; line-height: 1.0; font-weight: bold; color: #ffffff; text-transform: uppercase; text-decoration: none; border-radius: 30px; -webkit-border-radius: 30px; -moz-border-radius: 30px; display: block; padding: 12px 25px 12px 25px;">
                                                  VERIFY
                                              </a>
                                    </td>
                                  </tr>
                  ...
                  <!--                          <img src="" width="50" border="0" style="display: inline-block; width: 50px; height: auto; outline: none;">-->
                  <!--                        </td>-->
                  <!--                        <td align="left" style="font-family: 'Roboto', Arial, Helvetica, sans-serif; font-size: 18px; line-height: 1.4; color: #000000; padding: 15px 15px 15px 0; background-color: #EFEFF1;">-->
                  <!--                          Have a question? <br />-->
                    ...
                    <tr>
                      <td>
                        <table align="center" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" class="mobileView" style="" width="100%">
                          <!--<tr>-->
                          <!--  <td align="left" style="color: #88888f; font-family: 'Roboto', 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12px; line-height: 18px; font-weight:normal; padding: 10px 0px 0px 25px;" valign="middle" width="100%">-->
                          <!--    <a class="footerLinks" href="" style=" text-decoration: none; color: #88888f" target="_blank"><span class="contact">Contact</span></a>-->
                          <!--  </td>-->
                          <!--</tr>-->
                          <tr>
      ...
      <table border="0" cellpadding="0" cellspacing="0" class="hideDevice">
        <tr>
          <td class="hideDevice" height="1" style="min-width:700px; font-size:0px; line-height:0px;"><img height="1" src="" style="min-width: 700px; text-decoration: none; border: none; -ms-interpolation-mode: bicubic;"></td>
        </tr>
      </table>
